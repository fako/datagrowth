...
class TestInputOutputPaths(TestCase):
    ...
    def test_get_model_path(self):
        ...
        self.assertEqual(path, os.path.join(DATAGROWTH_CONFIGURATION.DATA_DIR, "community"))
        path = get_model_path("community", "classifiers")
        self.assertEqual(path, os.path.join(DATAGROWTH_CONFIGURATION.DATA_DIR, "community", "classifiers"))

    def test_get_media_path(self):
        path = get_media_path("community")
        self.assertEqual(path, os.path.join(DATAGROWTH_CONFIGURATION.WEB_MEDIA_ROOT, "community"))
        path = get_media_path("community", "videos")
        self.assertEqual(path, os.path.join(DATAGROWTH_CONFIGURATION.WEB_MEDIA_ROOT, "community", "videos"))
    ...
    def test_get_dumps_path(self):
        ...
        self.assertEqual(path, os.path.join(DATAGROWTH_CONFIGURATION.DATA_DIR, "resources", "dumps", "name"))
