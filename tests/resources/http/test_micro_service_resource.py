...
def test_prepare_inputs_creates_http_signature_with_connection_template_data(resource: MockMicroTikaResource) -> None:
    signature = resource.prepare_extract("get")
...
def test_prepare_inputs_ignores_extra_positional_url_arguments(resource: MockMicroTikaResource) -> None:
    signature = resource.prepare_extract("get", "unexpected-path-segment")
    assert "unexpected-path-segment" not in signature.args
...
def test_prepare_inputs_kwarg_overrides_connection_fields(resource: MockMicroTikaResource) -> None:
    signature = resource.prepare_extract("get", protocol="https", host="tika.example.com", path="/custom")
